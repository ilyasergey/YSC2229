...
``(42, "b")`` of a double-linked list containing pairs of integers can
...
double-linked list represented via three arrays, one should manipulate
...
* An implementation of a double-linked list, built on top of the
