...
So far we have only looked at directed graphs, where each edge,
besides the pair of connected nodes, also identified a *direction*. It
is uncommon, however, to consider *undirected* graphs, where each edge
establishes a symmetric link between two nodes.
